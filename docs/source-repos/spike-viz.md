...
|----|-------|--------|--------|--------|
| [#24](https://github.com/rmems/spike-viz/pull/24) | feat: CPU raster renderer (sparse/dense → PNG) | visualization | feature | 4 kept / 4 emitted. `render_raster()` on CPU. Closes #9. |
