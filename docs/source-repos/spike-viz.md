...
| [#23](https://github.com/rmems/spike-viz/pull/23) | fix: address PR #22 review comments | io | review-to-patch | 10 kept / 7 emitted (a pr-babysit automation status notice mistakenly ingested as a review signal was dropped). Explicit follow-up to #22 (cannot reopen). |
...
|----|----------------------|---------|---------------|---------|
| #23 | 10 | 7 | 7 | shortlisted (pair with #22; automation status notice dropped) |
